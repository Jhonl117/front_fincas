...
const listarClientes = async () => {
    ...
    await fetch(url, {
        ...
        .then(function (data) {
            ...
            listaClientes.forEach((usuario, index) => {
                ...
                usuario.botones_accion = `
                    <div class=" d-flex justify-content-around">
                        ...
                        <a href="" class="btn btn-warning" data-toggle="modal" data-target="#ShowModal" onclick='verClientes(${JSON.stringify(usuario)})'><i class="fas fa-eye"></i></a>
                    </div>
                `;
            });
